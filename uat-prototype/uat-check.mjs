...
record("JOURNEY-FOOTER-01", "Critical", "transport pages include journey footer", js.includes(">Arrived<") && js.includes("Change transport") && css.includes(".journey-footer"), "bottom actions continue or change transport");
