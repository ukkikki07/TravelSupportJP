...
record("GUIDANCE-TAP-01", "High", "train unsure cases are tappable", js.includes("data-help-index") && js.includes("guidance-button") && js.includes("If you are unsure about platform or direction"), "If unsure can reuse the existing Japanese help card");
