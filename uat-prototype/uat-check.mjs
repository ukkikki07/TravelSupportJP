...
record("JOURNEY-FOOTER-01", "Critical", "transport pages include journey footer", js.includes("Arrived / Change transport") && css.includes(".journey-footer"), "single bottom action continues or changes transport");
