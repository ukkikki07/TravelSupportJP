...
record("SHOWDEST-01", "Critical", "show final destination phrase is heading state", js.includes("私はこの場所に向かっています。") && js.includes("I am heading to this place.") && js.includes("show-destination-block") && css.includes(".show-destination-block strong") && css.includes("clamp(1.8rem"), "Show Final Destination uses heading-to-place phrasing with large destination context");
