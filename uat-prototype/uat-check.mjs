...
record("TRANSIT-TIMING-01", "High", "other transport pages use selective timing labels", js.includes("Before getting in taxi") && js.includes("After taxi stops, ask driver before it starts") && js.includes("Before going to the bus stop") && js.includes("At the bus stop, before the bus arrives") && js.includes("Before boarding") && js.includes("At the boarding place") && js.includes("Confirm reserved or non-reserved seat") && js.includes("helpIndex"), "taxi, bus, limited express, and highway bus actions keep time order without extra note blocks");
