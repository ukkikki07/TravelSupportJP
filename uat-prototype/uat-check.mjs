...
record("GUIDANCE-TAP-01", "High", "unsure cases are tappable", js.includes("helpByScreen") && js.includes("data-help-index") && js.includes("guidance-button") && js.includes("If Google Maps shows multiple results") && js.includes("Show the Google Maps screen to confirm which station this train should go toward.") && js.includes("If the bus stop direction is unclear") && js.includes("Show the Google Maps screen to confirm the boarding place, building, floor, or number."), "If unsure can reuse the existing Japanese help card");
...
record("TAXI-PARTIAL-01", "High", "partial taxi copy is not limited to stations or bus stops", js.includes("Show the taxi destination in Google Maps.") && js.includes("Googleマップの{taxiDestinationLabel}までタクシーで行きたいです。") && js.includes("function buildTaxiDestinationLabel") && !js.includes("Show the next station or bus stop if using taxi only for this section") && !js.includes("I want to go only to the next station or bus stop by taxi") && js.includes("If the taxi is only for part of the trip"), "Partial taxi destination copy stays generic");
record("TRANSPORT-GOAL-01", "Critical", "transport destination is confirmed through Google Maps", js.includes("function buildTransportDestinationLabel") && js.includes("{transportDestinationLabel}") && js.includes("Show the bus destination in Google Maps") && js.includes("Show the train destination in Google Maps") && js.includes("Show the boarding place in Google Maps") && js.includes("Show this transport destination in Google Maps") && js.includes("Googleマップの{transportDestinationLabel}"), "Each transport page can ask someone to confirm the transport goal in Google Maps");
