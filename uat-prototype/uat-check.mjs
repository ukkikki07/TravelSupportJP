...
record("GUIDANCE-TAP-01", "High", "unsure cases are tappable", js.includes("helpByScreen") && js.includes("data-help-index") && js.includes("guidance-button") && js.includes("If you are unsure about platform or direction") && js.includes("If the bus stop direction is unclear") && js.includes("If the boarding place is unclear"), "If unsure can reuse the existing Japanese help card");
