...
record("TRANSIT-TIMING-01", "High", "other transport pages use selective timing labels", js.includes("Before going to the bus stop") && js.includes("At the bus stop, before the bus arrives") && js.includes("Before boarding") && js.includes("At the boarding place") && js.includes("helpIndex"), "bus, limited express, and highway bus actions keep time order without extra note blocks");
