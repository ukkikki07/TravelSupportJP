...
record("TRAIN-NOTE-01", "High", "train prep has station timeline notes", js.includes("timelineNotes:") && js.includes("Google Mapsのこの電車に乗りたいです。改札はどこですか？") && js.includes("data-timeline-note") && css.includes(".timeline-notes"), "station-area notes reveal matching Japanese help in order");
